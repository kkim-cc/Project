...
// DESCRIPTION		: Maintains the list of high scores.
//                 					   
...
namespace WMP_Project
{
    ...
    public sealed partial class LeaderBoardPage : Page
    {
        ...
        {
            string fileContent = MainPage.fileContent;
            ...
            if (fileContent.Length > 0)
            {
                ...
                for (int i = 0; i < line.Length; i++)
                {
                    ...
                    if (field.Length >= 2)
                    {
                        ...
                        {
                            if (ntime < 60)
                                strbuf = String.Format(" UserName: {0,-40} GameTime: ({1} seconds)", field[0], ntime);
                            else
                                strbuf = String.Format(" UserName: {0,-40} GameTime: ({1} mins {2} seconds)", field[0], ntime / 60, ntime % 60);
                        }
